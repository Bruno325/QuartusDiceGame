...
1. Flip the rightmost switch (labeled SW[0] on the board) to start/"power on" the game, displaying the score. 1 LED will be turned on to indicate Player 1's turn.
